<?php namespace App\Http\Controllers;
	...
	class AdminSolicitudClienteController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "solicitud_cliente";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Numero de la solicitud","name"=>"numero_solicitud"];
			$this->col[] = ["label"=>"Empresa","name"=>"id_empresa","join"=>"clientes,Nombre_Empresa"];
			$this->col[] = ["label"=>"Cliente","name"=>"id_cliente","join"=>"clientes,Nombre_Cliente"];
			$this->col[] = ["label"=>"Estado Solicitud","name"=>"Estado_Solicitud"];
